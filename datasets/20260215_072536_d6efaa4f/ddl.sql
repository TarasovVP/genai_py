...
CREATE TABLE Employees (
 ...
 employment_status TEXT NOT NULL CHECK (employment_status IN ('Full-time', 'Part-time', 'Contract', 'Temporary')),
...
CREATE TABLE Projects (
 ...
 end_date DATE,
 company_id INT NOT NULL,
 project_status TEXT NOT NULL CHECK (project_status IN ('Planning', 'In Progress', 'Completed', 'On Hold', 'Cancelled')),
 budget DECIMAL(12, 2),
 FOREIGN KEY (company_id) REFERENCES Companies(company_id)
);
...
CREATE TABLE Performance_Reviews (
 ...
 comments TEXT,
 goals_set TEXT,
 review_status TEXT DEFAULT 'Draft' CHECK (review_status IN ('Draft', 'Final', 'Approved')),
 FOREIGN KEY (employee_id) REFERENCES Employees(employee_id),
